    ...
    <form @submit.prevent="submit" class="h-fit w-fit flex justify-center">
        <div
            ...
            <div class="flex flex-col">
                ...
                <textarea class=" border-2 px-2 py-1 border-[#59d460]" v-model="form.note" name="note" id="note"
            ...
            <div class="flex justify-center gap-4">
                ...
                <Link @click="deleted" :href="href" method="delete" as="button" type="button"
                    class="bg-red-500 p-3 rounded-lg px-6 text-white">Delete</Link>
            </div>
        </div>
    </form>
</template>
...
export default {
    ...
    mounted() {
        this.form.name = this.category.name,
            ...
            this.form.note = this.category.note
    },
    data() {
        return {
